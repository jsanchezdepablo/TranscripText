...
function sydney_slider_template() {
    ...
    $button_start   = sydney_slider_button();
    $button_register = goToRegister();
...
function goToRegister() {
    ...
    if (isset($_COOKIE['wordpress_logged_in_bbfa5b726c6b7a9cf3cda9370be3ee91'])){
        return '<a href="registro" class="roll-button button-slider not-showed-register">Registro</a>';

    }else{
        return '<a href="registro" class="roll-button button-slider">Registro</a>';
    }
